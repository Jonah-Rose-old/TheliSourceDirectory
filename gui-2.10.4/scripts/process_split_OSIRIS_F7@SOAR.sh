...
do
  ...
  do
    ...
    tmp=`get_key ${FILE} "CAMERAID"`
    ${P_REPLACEKEY} ${BASE}_${k}.fits "CAMERAID= ${tmp}" DUMMY2
    tmp=`get_key ${FILE} "FILENAME"`
    ${P_REPLACEKEY} ${BASE}_${k}.fits "FILENAME= ${tmp}" DUMMY3
    ${P_REPLACEKEY} ${BASE}_${k}.fits "FILENAME= ${FILE}" DUMMY4
    ${P_REPLACEKEY} ${BASE}_${k}.fits "MJD-OBS = ${MJD}" DUMMY5

    mv ${BASE}_${k}.fits OSIRIS.${DATEOBS}_${k}.fits
