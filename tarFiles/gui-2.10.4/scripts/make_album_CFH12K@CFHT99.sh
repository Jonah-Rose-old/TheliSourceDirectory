...
cat ${TEMPDIR}/imagelist_$$ |\
{
  ...
  do
	...
	-p -32 12600 8300 ${BASE}1$3.fits ${BASE}2$3.fits \
	${BASE}3$3.fits ${BASE}4$3.fits ${BASE}5$3.fits ${BASE}6$3.fits \
	${BASE}7$3.fits ${BASE}8$3.fits ${BASE}9$3.fits ${BASE}10$3.fits \
        ${BASE}11$3.fits ${BASE}12$3.fits \
