...
do
  ...
  do
    ...
    mv ${BASE}_${k}.fits GSAOI.chip4.${FILTER}.${DATEOBS}_${k}.fits
    k=$(( $k + 1 ))
  done

  mv ${FILE} ORIGINALS/${BASE}${SUFFIX}

  rm GSAOI.chip4.${FILTER}.${DATEOBS}_[1,2,3].fits
  mv GSAOI.chip4.${FILTER}.${DATEOBS}_4.fits GSAOI.chip4.${FILTER}.${DATEOBS}_1.fits
done
