/* 
   ...
   29.01.2005:
   removed compiler warnings under Linux gcc
   with -O3 -Wall

   24.07.2007:
   I explicitely cast variables whose result can exceed
   the range of an int.

   29.07.2007:
   I improved the change made at 24.07.2007 by declaring
   variables as type OFF_T instead of casting calculation 
...
int	remove_tab(catstruct *cat, char *tabname, int seg)
  ...
  {
   tabstruct	*tab, *prevtab, *nexttab = NULL;
   int		i,nseg;
