...
/*
	$Id: optimization.c,v 1.2 2004/07/20 13:20:19 terben Exp $
	$Author: terben $
	$Date: 2004/07/20 13:20:19 $
	$Revision: 1.2 $
*/

/*
  20.07.2004:
  I included 'comm.h' to avoid compiler warnings due to
  implicitely declared e_comment and e_error functions.
 */
