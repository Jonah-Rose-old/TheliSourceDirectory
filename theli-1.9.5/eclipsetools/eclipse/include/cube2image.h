...
/*
    $Id: cube2image.h,v 1.1 2003/09/04 15:44:41 terben Exp $
    $Author: terben $
...
/**
  @brief    Average a cube to a median image 
	    ...
	    in the final median. If less than 5 pixels remain
...
/*--------------------------------------------------------------------------*/
/* <python> */
image_t * cube_avg_median_minmax_rej(cube_t * to_average, 
                                     pixelvalue min,
                                     pixelvalue max,
                                     int lo_rej,
                                     int hi_rej,
