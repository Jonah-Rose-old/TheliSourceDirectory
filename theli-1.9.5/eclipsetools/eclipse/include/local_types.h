...
/* FILE HISTORY:
   ...
   14.01.2014:
   I commnented out the definition of 'inline' because it led to uncompilable
   code on MAC OSX 10.9.
*/


/*
	$Id: local_types.h,v 1.2 2014/01/14 18:08:14 thomas Exp $
	$Author: thomas $
	$Date: 2014/01/14 18:08:14 $
	$Revision: 1.2 $
 */
...
/* The following definition of 'inline' causes eclipse code to no longer
   compile on MAC 10.9. I therefore commented it out.
*/
