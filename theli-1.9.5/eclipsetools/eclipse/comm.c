...
/*
	$Id: comm.c,v 1.2 2004/08/24 22:23:26 terben Exp $
	$Author: terben $
	$Date: 2004/08/24 22:23:26 $
	$Revision: 1.2 $

25.04.04:
corrected a bug in subsequent calls from vfprintf and vsprintf:
Before the second function is called, the argument list has
to be cleaned up and reinitialised (va_end and va_start calls)
*/
