...
/*
 * 05.05.03:
 * included the tsize.h file if we need byte swapping
 *
 * 03.01.05:
 * function read_field:
 * I resolved a potential problem with the rfield
 * variable. It was defined int but could be used
 * as a LONG if FIELD_POS is of that type.
 */
