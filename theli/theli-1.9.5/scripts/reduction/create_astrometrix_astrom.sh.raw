...
#
# 06.05.2008:
# The standard astrometric catalogue is now USNO-B1. USNO-A2
# is no longer supported by the cdsclient which is used to retrieve
# the standardstar catalogue over the net.
#
# 21.12.2008:
