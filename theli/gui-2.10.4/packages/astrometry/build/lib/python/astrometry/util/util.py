...
_util.TRUE_swigconstant(_util)
TRUE = _util.TRUE

_util.FALSE_swigconstant(_util)
FALSE = _util.FALSE
...
def median_smooth(np_image, np_mask, halfbox, np_smooth):
    return _util.median_smooth(np_image, np_mask, halfbox, np_smooth)
median_smooth = _util.median_smooth

_util.L_swigconstant(_util)
L = _util.L
...
def lanczos3_filter(np_dx, np_f):
    return _util.lanczos3_filter(np_dx, np_f)
lanczos3_filter = _util.lanczos3_filter

def lanczos3_filter_table(np_dx, np_f, rangecheck):
    return _util.lanczos3_filter_table(np_dx, np_f, rangecheck)
lanczos3_filter_table = _util.lanczos3_filter_table

def lanczos_shift_image_c(np_img, np_weight, np_outimg, np_outweight, order, dx, dy):
    return _util.lanczos_shift_image_c(np_img, np_weight, np_outimg, np_outweight, order, dx, dy)
...
_util.DEFAULT_INDEX_JITTER_swigconstant(_util)
...
_util.INDEX_ONLY_LOAD_METADATA_swigconstant(_util)
...
_util.AN_FILETYPE_CODETREE_swigconstant(_util)
AN_FILETYPE_CODETREE = _util.AN_FILETYPE_CODETREE

_util.CODETREE_NAME_swigconstant(_util)
...
_util.AN_FILETYPE_STARTREE_swigconstant(_util)
AN_FILETYPE_STARTREE = _util.AN_FILETYPE_STARTREE

_util.AN_FILETYPE_TAGALONG_swigconstant(_util)
AN_FILETYPE_TAGALONG = _util.AN_FILETYPE_TAGALONG

_util.STARTREE_NAME_swigconstant(_util)
...
_util.HP_MAX_INT_NSIDE_swigconstant(_util)
...
_util.ANWCS_TYPE_WCSLIB_swigconstant(_util)
ANWCS_TYPE_WCSLIB = _util.ANWCS_TYPE_WCSLIB

_util.ANWCS_TYPE_SIP_swigconstant(_util)
ANWCS_TYPE_SIP = _util.ANWCS_TYPE_SIP

_util.ANWCS_TYPE_WCSTOOLS_swigconstant(_util)
...
_util.DIM_STARS_swigconstant(_util)
DIM_STARS = _util.DIM_STARS

_util.DIM_XY_swigconstant(_util)
DIM_XY = _util.DIM_XY

_util.DQMAX_swigconstant(_util)
DQMAX = _util.DQMAX

_util.DCMAX_swigconstant(_util)
DCMAX = _util.DCMAX
...
_util.ONE_OVER_SIXTY_swigconstant(_util)
ONE_OVER_SIXTY = _util.ONE_OVER_SIXTY

_util.RAD_PER_DEG_swigconstant(_util)
RAD_PER_DEG = _util.RAD_PER_DEG

_util.RAD_PER_ARCMIN_swigconstant(_util)
RAD_PER_ARCMIN = _util.RAD_PER_ARCMIN

_util.RAD_PER_ARCSEC_swigconstant(_util)
RAD_PER_ARCSEC = _util.RAD_PER_ARCSEC

_util.DEG_PER_RAD_swigconstant(_util)
DEG_PER_RAD = _util.DEG_PER_RAD

_util.DEG_PER_ARCMIN_swigconstant(_util)
DEG_PER_ARCMIN = _util.DEG_PER_ARCMIN

_util.DEG_PER_ARCSEC_swigconstant(_util)
DEG_PER_ARCSEC = _util.DEG_PER_ARCSEC

_util.ARCMIN_PER_RAD_swigconstant(_util)
ARCMIN_PER_RAD = _util.ARCMIN_PER_RAD

_util.ARCMIN_PER_DEG_swigconstant(_util)
ARCMIN_PER_DEG = _util.ARCMIN_PER_DEG

_util.ARCMIN_PER_ARCSEC_swigconstant(_util)
ARCMIN_PER_ARCSEC = _util.ARCMIN_PER_ARCSEC

_util.ARCSEC_PER_RAD_swigconstant(_util)
ARCSEC_PER_RAD = _util.ARCSEC_PER_RAD

_util.ARCSEC_PER_DEG_swigconstant(_util)
ARCSEC_PER_DEG = _util.ARCSEC_PER_DEG

_util.ARCSEC_PER_ARCMIN_swigconstant(_util)
...
_util.MJD_JD_OFFSET_swigconstant(_util)
...
_util.HELP_ERR_swigconstant(_util)
HELP_ERR = _util.HELP_ERR

_util.OPT_ERR_swigconstant(_util)
...
_util.SIP_MAXORDER_swigconstant(_util)
...
def coadd_add_numpy(c, np_img, np_weight, fweight, wcs):
    return _util.coadd_add_numpy(c, np_img, np_weight, fweight, wcs)
...
def fit_sip_wcs_py(np_starxyz, np_fieldxy, np_weights, tanin, sip_order, inv_order):
    return _util.fit_sip_wcs_py(np_starxyz, np_fieldxy, np_weights, tanin, sip_order, inv_order)
...
def tan_wcs_resample(inwcs, outwcs, np_inimg, np_outimg, weighted, lorder):
    return _util.tan_wcs_resample(inwcs, outwcs, np_inimg, np_outimg, weighted, lorder)
