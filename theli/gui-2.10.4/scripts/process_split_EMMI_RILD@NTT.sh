...
do
  ...
  FILTER=`get_key ${FILE} "HIERARCH ESO INS FILT2 NAME" | ${P_CLEANSTRING}`
  ...
  cd11="-9.2944e-5 -9.2944e-5"
  cd12="0.0 0.0"
  cd21="0.0 0.0"
  cd22="9.2944e-5 9.2944e-5"
  cpx1="500 -540"
  cpx2="1503 1492"
  ...
  ${P_REPLACEKEY} ${BASE}_1.fits "CRPIX1  = 500" CRPIX1
  ${P_REPLACEKEY} ${BASE}_1.fits "CRPIX2  = 1503" CRPIX2
  ${P_REPLACEKEY} ${BASE}_2.fits "CRPIX1  = -540" CRPIX1
  ${P_REPLACEKEY} ${BASE}_2.fits "CRPIX2  = 1492" CRPIX2
