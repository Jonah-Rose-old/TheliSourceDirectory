...
do
  ...
  do
    ...
    ${P_REPLACEKEY} ${BASE}_${k}.fits "EXPT_DIT= ${DIT}" DUMMY4
    ...
    mv ${BASE}_${k}.fits GSAOI.chip3.${FILTER}.${DATEOBS}_${k}.fits
    k=$(( $k + 1 ))
  done

  mv ${FILE} ORIGINALS/${BASE}${SUFFIX}

  rm GSAOI.chip3.${FILTER}.${DATEOBS}_[1,2,4].fits
  mv GSAOI.chip3.${FILTER}.${DATEOBS}_3.fits GSAOI.chip3.${FILTER}.${DATEOBS}_1.fits
done
