...
do
  ...
  do
    ...
    mv ${BASE}_${k}.fits GSAOI.chip2.${FILTER}.${DATEOBS}_${k}.fits
    k=$(( $k + 1 ))
  done

  mv ${FILE} ORIGINALS/${BASE}${SUFFIX}

  rm GSAOI.chip2.${FILTER}.${DATEOBS}_[1,3,4].fits
  mv GSAOI.chip2.${FILTER}.${DATEOBS}_2.fits GSAOI.chip2.${FILTER}.${DATEOBS}_1.fits
done
