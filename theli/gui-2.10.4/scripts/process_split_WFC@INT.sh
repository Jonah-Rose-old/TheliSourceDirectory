...
#  ${P_REPLACEKEY} ${BASE}_1.fits "CRPIX1  = 2045" CRPIX1
#  ${P_REPLACEKEY} ${BASE}_1.fits "CRPIX2  = 3155" CRPIX2
#  ${P_REPLACEKEY} ${BASE}_2.fits "CRPIX1  = -2070" CRPIX1
#  ${P_REPLACEKEY} ${BASE}_2.fits "CRPIX2  = 3190" CRPIX2
#  ${P_REPLACEKEY} ${BASE}_3.fits "CRPIX1  = 2035" CRPIX1
#  ${P_REPLACEKEY} ${BASE}_3.fits "CRPIX2  = -1040" CRPIX2
#  ${P_REPLACEKEY} ${BASE}_4.fits "CRPIX1  = 2050" CRPIX1
#  ${P_REPLACEKEY} ${BASE}_4.fits "CRPIX2  = 1060" CRPIX2
#  ${P_REPLACEKEY} ${BASE}_1.fits "CRPIX1  = 2845" CRPIX1
#  ${P_REPLACEKEY} ${BASE}_1.fits "CRPIX2  = 2755" CRPIX2
#  ${P_REPLACEKEY} ${BASE}_2.fits "CRPIX1  = -1340" CRPIX1
#  ${P_REPLACEKEY} ${BASE}_2.fits "CRPIX2  = 2710" CRPIX2
#  ${P_REPLACEKEY} ${BASE}_3.fits "CRPIX1  = 2835" CRPIX1
#  ${P_REPLACEKEY} ${BASE}_3.fits "CRPIX2  = -1485" CRPIX2
#  ${P_REPLACEKEY} ${BASE}_4.fits "CRPIX1  = 2850" CRPIX1
#  ${P_REPLACEKEY} ${BASE}_4.fits "CRPIX2  = 660" CRPIX2

  ${P_REPLACEKEY} ${BASE}_1.fits "CRPIX1  = 2811" CRPIX1
  ${P_REPLACEKEY} ${BASE}_1.fits "CRPIX2  = 2810" CRPIX2
  ${P_REPLACEKEY} ${BASE}_2.fits "CRPIX1  = -1379" CRPIX1
  ${P_REPLACEKEY} ${BASE}_2.fits "CRPIX2  = 2794" CRPIX2
  ${P_REPLACEKEY} ${BASE}_3.fits "CRPIX1  = 2759" CRPIX1
  ${P_REPLACEKEY} ${BASE}_3.fits "CRPIX2  = -1421" CRPIX2
  ${P_REPLACEKEY} ${BASE}_4.fits "CRPIX1  = 2790" CRPIX1
  ${P_REPLACEKEY} ${BASE}_4.fits "CRPIX2  = 689" CRPIX2
