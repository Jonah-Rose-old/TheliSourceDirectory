...
# deal with the funny aperture stuff of the WHT system:
  ...
  while [ "${k}" -le "${NCHIPS}" ]
  do
      # CD matrix can be fixed as the rotator angle of PFIP is not changed
      ${P_REPLACEKEY} ${BASE}_${k}.fits "CD1_1   = -7.304e-05" CD1_1
      ${P_REPLACEKEY} ${BASE}_${k}.fits "CD1_2   = -1.275e-06" CD1_2
      ${P_REPLACEKEY} ${BASE}_${k}.fits "CD2_1   = -1.275e-06" CD2_1
      ${P_REPLACEKEY} ${BASE}_${k}.fits "CD2_2   =  7.304e-05" CD2_2
